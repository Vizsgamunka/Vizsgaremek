...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Rend_tetel::create(['rendeles' => '1', 'termek' => '4', 'rend_menny' => 2]);
        Rend_tetel::create(['rendeles' => '2', 'termek' => '2', 'rend_menny' => 1]);
        Rend_tetel::create(['rendeles' => '3', 'termek' => '3', 'rend_menny' => 2]);
        Rend_tetel::create(['rendeles' => '3', 'termek' => '5', 'rend_menny' => 3]);
        Rend_tetel::create(['rendeles' => '3', 'termek' => '7', 'rend_menny' => 1]);
